...
parallel --will-cite -j 200% "echo -e \"${WHITE}Taking Screenshots of objects in {}.. ${NC}\"; if echo ./scripts/screenshot.py {}; then echo -e \"${GREEN}Success. ${NC}\"; else echo -e \"${RED}Failed, code $?. ${NC}\"; EXIT_CODE=1; fi" < .tmp_modified_configs.txt
